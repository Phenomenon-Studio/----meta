...
<main>
    ...
    <section class="primary">
        <picture class="primary__pic">
            <source srcset="<?php bloginfo('template_directory'); ?>/assets/images/main-2-mob.png" media="(max-width: 479px)">
            <img src="<?php bloginfo('template_directory'); ?>/assets/images/main-2.png" alt="" loading="lazy">  
                ...
                <div class="flex items-center justify-center h-full">
                    <div class="w-full text-center">
                        <h1 class="color-white">
                            Asia's first social AR/VR NFT marketplace 
                            <!-- <?php the_field('heading_1'); ?> -->
                        </h1>
                        <div class="mt-30 xs-max:mt-25">
                            <a class="btn btn--primary" href="#" target="_self">Join the waitlist</a>
